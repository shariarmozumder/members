    ...
    <option value="EasyPaisa">EasyPaisa</option>
     <option value="Jazz Cash">Jazz Cash</option>
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Your School Profile:</h6>
                        </div>
                        <div class="card-body">
                          <h6 class="m-0 font-weight-bold text-primary">School Name:</h6>
<?php echo $school;?>
<br><br>
<h6 class="m-0 font-weight-bold text-primary">School Address:</h6>
<?php echo $address;?>
<br><br>
<h6 class="m-0 font-weight-bold text-primary">Owner Name:</h6>
<?php echo $name;?>
<br><br>
<h6 class="m-0 font-weight-bold text-primary">PEF Program:</h6>
<?php echo $program;?> Last QAT Result <?php echo $qatr;?><br><br>
<h6 class="m-0 font-weight-bold text-primary">Contact Number:</h6>
<?php echo $contact;?><br><br>
<h6 class="m-0 font-weight-bold text-primary">Your CNIC:</h6>
<?php echo $cnic;?><br><br>
